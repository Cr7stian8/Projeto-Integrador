...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		assertEquals(requisicao.getBody().getNomeUsuario(), resposta.getBody().getNomeUsuario());
		assertEquals(requisicao.getBody().getFotoUsuario(), resposta.getBody().getFotoUsuario());
	...
	public void deveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getIdUsuario(), "Juliana Andrews Ramos",
	...
	public void deveAutenticarUsuario() {
		...
		HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(
				new UsuarioLogin(0L, "Maria", "marisa_souza@email.com.br", "13465278", "", ""));
